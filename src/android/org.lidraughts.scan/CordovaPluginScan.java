...
public final class CordovaPluginScan extends CordovaPlugin {
  ...
  private void uiExit(CallbackContext callbackContext) throws JSONException {
    if(isInit) {
      ...
      callbackContext.error("Scan isn't currently running!");
    }
  }
  ...
  private void sendOutput(String output) {
    ...
    webView.postMessage("scan", output);
  }
